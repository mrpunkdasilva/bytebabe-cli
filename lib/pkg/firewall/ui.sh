...
show_firewall_menu() {
    ...
    echo -e "${CYBER_PURPLE}╚════════════════════════════════════════════╝${RESET}"
    echo
    echo -e "${CYBER_PURPLE}1) ${CYBER_CYAN}Install/Detect Firewall${RESET}"
    echo -e "${CYBER_PURPLE}2) ${CYBER_GREEN}View Firewall Status${RESET}"
    echo -e "${CYBER_PURPLE}3) ${CYBER_BLUE}Enable Firewall${RESET}"
    echo -e "${CYBER_PURPLE}4) ${CYBER_RED}Disable Firewall${RESET}"
    echo -e "${CYBER_PURPLE}5) ${CYBER_YELLOW}List Active Rules${RESET}"
    echo -e "${CYBER_PURPLE}6) ${CYBER_CYAN}Add New Rule${RESET}"
    echo -e "${CYBER_PURPLE}7) ${CYBER_RED}Remove Rule${RESET}"
    echo -e "${CYBER_PURPLE}8) ${CYBER_YELLOW}Reset All Rules${RESET}"
    echo -e "${CYBER_PURPLE}9) ${CYBER_BLUE}Quick Setup Profiles${RESET}"
    echo -e "${CYBER_PURPLE}10) ${CYBER_GREEN}Advanced Options${RESET}"
