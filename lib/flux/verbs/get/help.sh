...
show_get_help() {
    ...
    echo -e "  ${CYBER_GREEN}-q, --query${RESET}     Add query parameters (can be used multiple times)"
    echo -e "                  Example: -q 'page=1' -q 'limit=10'"
    ...
    echo -e "  ${CYBER_GREEN}-v, --verbose${RESET}   Show detailed request information"
    ...
    echo -e "  ${CYBER_YELLOW}# GET request with query parameters${RESET}"
    echo -e "  flux get https://api.example.com -q 'page=1' -q 'limit=10'\n"
