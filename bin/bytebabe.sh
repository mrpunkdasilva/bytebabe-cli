...
case "$1" in
    ...
    *)
        ...
        echo -e "    ${CYBER_GRAY}└─ start/stop${RESET} Database service control"
        echo -e "  ${CYBER_GREEN}datavision${RESET}, ${CYBER_GREEN}dv${RESET}  Database visualization tool"
        echo -e "    ${CYBER_GRAY}└─ show${RESET}      Display table data"
        echo -e "    ${CYBER_GRAY}└─ schema${RESET}    Show table schema"
        echo -e "    ${CYBER_GRAY}└─ stats${RESET}     Display table statistics"
        echo -e "    ${CYBER_GRAY}└─ search${RESET}    Search table data"
        echo -e ""
